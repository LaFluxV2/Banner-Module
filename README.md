# Banner Component for Laflux

Laflux is a Hybrid Platform built with Laravel 5.3. This is the Banner component for Laflux.

## Getting Started

Banner component is used for displaying banners on the front end.From the backend there is  a CRUD option to View, Add, Edit, Publish/Unpublish, Trash banners. You can create as many as banner categories. Click here for the [Demo](http://demo.laflux.com/admin/dashboard). Default Username : demo@laflux.com, Password : 123456.
...
```
git submodule add https://github.com/LaFlux/Banners.git packages/ExtensionsValley/Banners/
